...
public class Basket extends ArrayList<Product> implements Serializable {
     ...
     * If the product already exists in the basket, it updates the quantity.
     * Otherwise, it appends the product to the basket.
     * @param pr A product to be added to the basket
     * @return true if successfully adds the product or updates quantity
     */
    @Override
    public boolean add(Product pr) {
        ...
        // Product doesn't exist; add it to the basket
        return super.add(pr);
    }
     ...
     * @param productNum The product number to search for
